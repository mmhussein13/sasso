"""
Django settings for sasso project.
...
SECRET_KEY = 'django-insecure-^o+g&@^8*6dj63c&ulxh$yk1fj@(ma%f+^51-00upg&h1$ecva'
...
WSGI_APPLICATION = 'sasso.wsgi.application'
